            ...
            <div class="col-sm-6 col-lg-3">
                <div class="card text-white bg-flat-color-1">
                    <div class="card-body pb-0">
                        <div class="dropdown float-right">
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton3">
                                <div class="dropdown-menu-content">
                                    <a class="dropdown-item" href="<?=site_url('Pengguna/read')?>">Lihat Informasi</a>
                                </div>
                            </div>
                        </div>
                        <h4 class="mb-0">
                        ...
                        <p class="text-light">User dan Admin</p>
                ...
                <div class="card text-white bg-flat-color-2">
                    <div class="card-body pb-0">
                        <div class="dropdown float-right">
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton3">
                                <div class="dropdown-menu-content">
                                    <a class="dropdown-item" href="<?=site_url('Kamar/read')?>">Lihat Informasi</a>
                                </div>
                            </div>
                        </div>
                        <h4 class="mb-0">
                        ...
                        <div class="chart-wrapper px-0" style="height:72px;" height="70">
                ...
                <div class="card text-white bg-flat-color-3">
                    <div class="card-body pb-0">
                        <div class="dropdown float-right">
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton3">
                                <div class="dropdown-menu-content">
                                   <a class="dropdown-item" href="<?=site_url('Transaksi/read')?>">Lihat Informasi</a>
                                </div>
                            </div>
                        </div>
                        <h4 class="mb-0">
